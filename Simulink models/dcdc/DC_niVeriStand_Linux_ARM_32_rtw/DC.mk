# File    : DC.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= DC
MODULES         		= DC_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		= DC.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= D:/Desktop/THESIS~2/SIMULI~1/dcdc
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 2
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/DC_niVeriStand_Linux_ARM_32_rtw \
	-I$(START_DIR) \
