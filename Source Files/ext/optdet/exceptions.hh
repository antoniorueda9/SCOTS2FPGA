 ...
 *
 * Created on August 30, 2017, 9:13 AM
 */
...
ASSERT_CONDITION_THROW(DO_SANITY_CHECKS && (CONDITION), MESSAGE);
             ...
             */
            class tud_exception : public exception {
            private:
            ...
            public:
                ...
                explicit tud_exception(const char * message) : exception(), msg(message) {
                }

                explicit tud_exception(const string &message) : exception(), msg(message) {
                }
                 ...
                 */
                tud_exception(tud_exception const & other) {
                    this->msg = other.msg;
                }
