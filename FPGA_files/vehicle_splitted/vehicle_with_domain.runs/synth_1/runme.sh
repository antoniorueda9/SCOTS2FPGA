...
HD_PWD='D:/Desktop/new_files_22-may/vehicle/vehicle_with_domain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DD.tcl
