...
HD_PWD='D:/Desktop/Project/new_files/vehicle_converted_2_to_1/vehicle_TUM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bddWrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bddWrapper.tcl
